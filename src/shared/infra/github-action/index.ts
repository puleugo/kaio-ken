...
import { setupGithubUploadAuth } from "@src/module/infra/github-actions/setup-github-upload-auth";
...
GithubActionRunner.addBootstrapHandler(setupGithubUploadAuth);
